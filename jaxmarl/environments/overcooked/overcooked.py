...
class Overcooked(MultiAgentEnv):
    ...
    def step_agents(
        ...
        candidate_maze_map, alice_inv, alice_reward, alice_shaped_reward, allice_delivery = self.process_interact(maze_map, state.wall_map, fwd_pos, state.agent_inv, 0)
        ...
        candidate_maze_map, bob_inv, bob_reward, bob_shaped_reward, bob_delivery = self.process_interact(maze_map, state.wall_map, fwd_pos, state.agent_inv, 1)
